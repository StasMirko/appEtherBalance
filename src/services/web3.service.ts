...
import { contractABI, UnitEnum } from '../constants';
...
class Web3Service {
  ...
  public async getBalance(): Promise<string> {
    ...
    return this.web3.utils.fromWei(balance, UnitEnum.ETHER);
  }
  ...
  public async getTokenBalances(tokenAddresses: string[]): Promise<string[]> {
    ...
    for (const tokenAddress of tokenAddresses) {
      ...
      tokenBalances.push(this.web3.utils.fromWei(tokenBalance, 'tether')); //TODO
    }
